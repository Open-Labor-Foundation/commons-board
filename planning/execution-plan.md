...
Source: the pre-OLF `mother-board` codebase (private, predates this repo).
...
### Phase 8 — Company Creation

**Goal:** Levels 1–3 of company creation (Design → Provision+Assist → Operate-with-caps). Full migration of `launch/*`.
